                                                    ...
                                                    <button className='btn btn-dark'
                                                        ...
                                                        onClick={() => {
                                                            if(studentTicketNumber === 0 && adultTicketNumber === 0) {
                                                                toast.warning("Please select a ticket to continue", {
                                                                    theme: "dark",
                                                                    position: "top-center"
                                                                })
                                                            } else {
                                    ...
                                    <Form className='row justify-content-center align-items-start'>
                                        <div className='col-sm-12 col-md-6'>
                                            <div class="imput-group form-floating has-validation mb-3">
                                                <KaanKaplanTextInput name="fullName" type="text" class="form-control" id="fullName" placeholder="Full Name" required/>
                                        ...
                                        <div className='col-sm-12 col-md-6 mb-3'>
                                            ...
                                            <div className='row'>
                                                <div className='col-sm-6'>
                                                    <div class="form-floating mb-3">
                                                        <Cleave type="text" class="form-control" id="floatingCardLastDate" placeholder='Expiration Date' required
                                                        options={{date:true, datePattern: ['m','y']}} />
                                                        <label for="floatingCardLastDate">Expiration Date</label>
                                                    </div>
                                                </div>
                                                <div className='col-sm-6'>
                                                    <div class="form-floating mb-3">
                                                ...
                                                <p className='text-start'> <input class="form-check-input me-3" type="checkbox" value="" aria-label="Checkbox for following text input" required/>I have read and agree to the Preliminary Information Conditions and the Distance Sales Agreement.
                                            </p>
                                            </div>
                                        </div>
