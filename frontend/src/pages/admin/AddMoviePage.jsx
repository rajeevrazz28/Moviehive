  ...
  return (
    <div>
        <div className='mt-5 p-5 container' style={{height: "100vh"}}>
            ...
            <h5 className='my-4'>
                Fill in the movie information completely and proceed to select the actors of the movie.
            </h5>
            ...
            <Formik 
                ...
                <div class="form-floating mb-3">
                    <KaanKaplanTextInput name='directorName' type="text" class="form-control" id="directorName" placeholder="Director's Name" />
